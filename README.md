...
```
npm create cloudflare@latest -- --template=cloudflare/templates/odd-morning-7556
```

A live public deployment of this template is available at [https://odd-morning-7556.templates.workers.dev](https://odd-morning-7556.templates.workers.dev)
